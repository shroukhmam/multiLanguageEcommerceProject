...
Route::group([
    ...
    Route::group(['namespace' => 'Site', 'middleware' => 'auth'], function () {
        ...
        Route::group(['prefix' => 'cart'], function () {
            ...
            Route::post('cart', 'CartController@postAdd')->name('site.cart.add');
            Route::post('/remove', 'CartController@destroy')->name('site.cart.delete');
            Route::post('/update', 'CartController@postUpdate')->name('site.cart.update');
