                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> {{__('admin/product.addnewproduct')}}    </h4>
                                    ...
                                    <div class="card-body">
                                        <form class="form"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i> {{__('admin/product.stock')}}    </h4>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> {{__('admin/product.code')}}   
                                                            </label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> {{__('admin/product.managestock')}} 
                                                            </label>
                                                            <select name="manage_stock" class="select2 form-control" id="manageStock">
                                                                <optgroup label="من فضلك أختر النوع ">
                                                                    <option value="1">{{__('admin/product.avaliabe')}}  </option>
                                                                    <option value="0" selected>  {{__('admin/product.notavaliable')}} </option>
                                                                </optgroup>
                                                            </select>
                                                            @error('manage_stock')
                                                            <span class="text-danger"> {{$message}}</span>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="in_stock" class="select2 form-control" >
                                                                <optgroup label="من فضلك أختر  ">
                                                                    <option value="1">{{__('admin/product.avail')}} </option>
                                                                    <option value="0">{{__('admin/product.avail')}}   </option>
                                                                </optgroup>
                                                            </select>
                                                            @error('in_stock')
                                                            <span class="text-danger"> {{$message}}</span>
                                            ...
                                            <div class="form-actions">
                                                <button type="button" class="btn btn-warning mr-1"
                                                    ...
                                                    <i class="ft-x"></i> {{__('admin/message.back')}} 
                                                </button>
                                                <button type="submit" class="btn btn-primary">
                                                    <i class="la la-check-square-o"></i> {{__('admin/message.edit')}} 
                                                </button>
                                            </div>
                                        </form>
