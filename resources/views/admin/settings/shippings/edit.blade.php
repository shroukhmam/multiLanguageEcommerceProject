                ...
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="">{{__('admin/shippings.main')}}  </a>
                                </li>

                                <li class="breadcrumb-item active">{{__('admin/shippings.delivaryTools')}} 
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> {{__('admin/shippings.edit')}} </h4>
                                        ...
                                        <form class="form" action="{{route('update.shippings.methods',$shippingMethod -> id)}}"
                                            ...
                                            <div class="form-actions">
                                                <button type="button" class="btn btn-warning mr-1"
                                                    ...
                                                    <i class="ft-x"></i> {{__('admin/shippings.back')}}
                                                </button>
                                                <button type="submit" class="btn btn-primary">
                                                    <i class="la la-check-square-o"></i> {{__('admin/shippings.save')}}
                                                </button>
                                            </div>
                                        </form>
                                    </div>
