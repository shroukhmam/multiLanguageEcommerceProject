                                                    ...
                                                    <div class="product-description">
                                                        <div class="product-groups">
                                                            ...
                                                            <div class="product-title" itemprop="name"><a
                                                                    href="audio/15-303-nunc-tempus-velit-quis-urnanb.html#/1-size-s/10-color-red">{{$product->name}}</a></div>
                                                    ...
                                                    <div class="col-12 col-w40 pl-0">
                                                        <div class="thumbnail-container">
                                                            ...
                                                            <a href="smartphone-tablet/1-40-hummingbird-printed-t-shirt.html#/1-size-s/6-color-taupe"
                                                               class="thumbnail product-thumbnail two-image">
                                                                <img class="img-fluid image-cover"
                                                                     src="{{$category->products[$i] -> images[0] -> photo ?? ''}}"
                                                                     alt=""
                                                        ...
                                                        <div class="product-description">
                                                            <div class="product-groups">
                                                                ...
                                                                <div class="product-title" itemprop="name"><a
                                                                        ...
                                                                        {{$category->products[$i]-> name}}</a></div>

                                                                <div class="product-group-price">

                                                                    <div class="product-price-and-shipping">
                                                                        <span itemprop="price"
                                                                   class="price">{{$category->products[$i] -> special_price ?? $category->products[$i] -> price }}</span>
                                                            @if($category->products[$i] -> special_price)
                                                                <span
                                                                    class="regular-price">{{$category->products[$i]-> price}}</span>
                                                            @endif
                                                            ...
                                                            <div class="product-buttons d-flex justify-content-center"
                                                                 ...
                                                                 <form
                                                                      ...
                                                                      method="post" class="formAddToCart">
                                                                       @csrf
                                                                         <a class="add-to-cart cart-addition" data-product-id="{{$category->products[$i]-> id}}" 
                                                                            href="#">
                                                                          <i class="novicon-cart"></i><span>Add to cart</span></a>
                                                                 </form>
                                                                <a class="addToWishlist  wishlistProd_22" href="#"
                                                               data-product-id="{{$category->products[$i]-> id}}"
                                                            >
                                                                <i class="fa fa-heart"></i>
                                                                <span>Add to Wishlist</span>
                                                            </a>
    ...
    <script>
        ...
        $(document).on('click', '.addToWishlist', function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    $(".alert-modal .mm").html(data.wished);
        ...
        $(document).on('click', '.cart-addition', function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    $(".alert-modal .mm").html(data.carted);
                   $('.alert-modal').css('display','block');
                   if(data.added){
